...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LimitTracking.ip'
        db.add_column('wapiti_limittracking', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LimitTracking.ip'
        db.delete_column('wapiti_limittracking', 'ip')
    ...
    models = {
        ...
        'wapiti.apikey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'312tHxsXITVbCpM5QnJB9ymrv6aGo8jd'", 'max_length': '32'}),
